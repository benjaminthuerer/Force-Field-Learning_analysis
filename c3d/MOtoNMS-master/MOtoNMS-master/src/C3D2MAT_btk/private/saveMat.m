function [] = saveMat(all, analogs, Markers, AnalogData, FPdata, Events, trialMatFolder)
%
...
if isempty(all)==0
    save([trialMatFolder 'all.mat'], 'all')
end

if isempty(analogs)==0
    save([trialMatFolder 'analogs.mat'], 'analogs')
end
